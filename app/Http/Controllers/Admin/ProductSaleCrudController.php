...
use App\Http\Requests\ProductSaleRequest as Request;

class ProductSaleCrudController extends BaseCrudController
{
    use Resources\ProductSale\Main;
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('starmoozie.base.route_prefix') . "/{$path}/{$product_id}/sale");
